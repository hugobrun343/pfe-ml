...
def init_wandb_from_args(args: Namespace, model, save_dir: Path, project_name: str = 'resnet3d-binary-classification', run_name: str = None, resume_id: Optional[str] = None, config_path: Optional[Path] = None, preprocessing_metadata_path: Optional[Path] = None):
    """
