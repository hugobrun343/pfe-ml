...
def init_wandb_from_args(args: Namespace, model, save_dir: Path, project_name: str = 'resnet3d-binary-classification'):
    """
    ...
    """
    # Create run name from save_dir (e.g., "resnet3d-50-split1-full-dataset")
